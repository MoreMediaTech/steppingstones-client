...
export function UpdatePartnerForm({
  ...
  partner: PartialPartnerWithOrganisationProps;
}) {
  ...
  const defaultValues = {
    ...
    closingDate: partner.closingDate,
    isEmail: partner.isEmail,
  };

  const { form, isCreating, updatePartnerHandler } =
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="h-[80vh] sm:min-w-[800px]">
          <DialogHeader>
            <DialogTitle>Update Partner</DialogTitle>
            <DialogDescription>Update the partner details</DialogDescription>
          </DialogHeader>
          <ScrollArea className="w-full p-2">
            <Form {...form}>
              <form
                ...
                onSubmit={form.handleSubmit(updatePartnerHandler)}
                className="px-2"
              >
