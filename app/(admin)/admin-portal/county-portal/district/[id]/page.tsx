...
export default function DistrictSection({ params}: { params: {id: string }}) {
  ...
  } = useGetDistrictSectionByIdQuery(params.id, { refetchOnMountOrArgChange: true })
              ...
              <section className="px-2 py-2 sm:px-4">
                <div className="flex justify-between">
                  <Button
                    ...
                    onClick={() => {
                      router.push(
                        `${NEXT_URL}/admin-portal/county-portal/district`
                      )
                    }}
                  >
                    Go Back
