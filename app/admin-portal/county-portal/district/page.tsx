                        ...
                        {districtData?.districtSections?.map(
                          (section: DistrictSectionProps) => (
                            <PortalButton
                              ...
                              onClick={() =>
                                router.push(
                                  `${NEXT_URL}/admin/editor-portal/county-portal/district/${section.id}?county=${router.query.county}&countyId=${router.query.countyId}&district=${router.query.district}&districtId=${router.query.districtId}`
                                )
                              }
                            >
                              {section.name}
