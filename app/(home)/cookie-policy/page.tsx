  ...
  return (
    <section className="relative mt-24 bg-slate-50 py-8">
      <section className="mx-4 space-y-4 py-4 text-justify text-sm font-thin md:container md:mx-auto md:max-w-screen-md md:py-8">
        ...
        <p>
          This Cookie Policy explains how Stepping Stones, a product of
          Equilibrium Startup Lab LLC ("Company", "we", "us", and "our") uses
        ...
        <p>
          Cookies set by the website owner (in this case, Equilibrium Startup
          Lab LLC) are called "first party cookies". Cookies set by parties
        ...
        <h2 className="font-semibold">How can I control cookies?</h2>
        <p>
        ...
        <p>
          ...
          please visit{' '}
          <a href="http://www.aboutads.info/choices/" className="underline">
            http://www.aboutads.info/choices/
          </a>{' '}
          or{' '}
          <a href="http://www.youronlinechoices.com" className="underline">
