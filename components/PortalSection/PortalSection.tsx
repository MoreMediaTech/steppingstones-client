        ...
        {links.map((link, index) => (
          <div key={`${link}-${index}`}>
            <Link href={`/admin/editor-portal/${link.path}`}>
              <a
                className="mx-4 flex h-40 flex-col items-center justify-center rounded-xl bg-[#5E17EB] text-lg font-semibold text-white shadow-lg transition delay-150 duration-300 
