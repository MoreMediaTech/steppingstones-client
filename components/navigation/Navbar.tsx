...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex sm:max-w-screen-lg items-center justify-between">
        ...
        <div className="flex flex-1 items-center justify-end sm:hidden">
          ...
          >
            <ul className="grid list-none grid-cols-1 gap-2 w-full ">
              {paths.map((path, index) => {
                if (activePath === path) {
                  return (
                    <li
              ...
              <li className="my-2 cursor-pointer font-poppins w-full text-[16px] font-medium">
                <Link
                  href={'/enquire'}
                  className="rounded-lg bg-[#5E17EB] px-6 py-2 w-full font-medium text-white"
                  onClick={() => {
                    setOpened(false)
