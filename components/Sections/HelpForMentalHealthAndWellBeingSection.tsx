...
const HelpForMentalHealthAndWellBeingSection = ({ id }: { id: string }) => {
  ...
  const [value, setValue] = useState(countyData?.topicalBusinessIssues?.helpForMentalHealthAndWellBeing?.content)
...
export default HelpForMentalHealthAndWellBeingSection
