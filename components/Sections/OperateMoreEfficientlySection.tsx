...
const OperateMoreEfficientlySection = ({ id }: { id: string }) => {
  ...
  const [value, setValue] = useState(
    countyData?.growingABusiness?.operateMoreEfficiently?.content
  )
      ...
      <section className="container">
        {isLoadingCounty ? (
          ...
          <Paper shadow="lg" p="md" radius="md" withBorder className="w-full">
            ...
            {!isEdit && countyData?.growingABusiness?.operateMoreEfficiently ? (
              <ContentPreview
                content={countyData?.growingABusiness?.operateMoreEfficiently}
              />
            ) : (
              <CountySectionForm
                register={register}
...
export default OperateMoreEfficientlySection
