...
const HelpForSocialEnterprisesSection = ({ id }: { id: string }) => {
  ...
  const [updateOrCreateSocialEnterprises, { isLoading }] = useUpdateOrCreateSocialEnterprisesMutation()

  const [value, setValue] = useState<string>(countyData?.topicalBusinessIssues?.helpForSocialEnterprises?.content)
  ...
  const {
    ...
    defaultValues: {
      title: countyData?.topicalBusinessIssues?.helpForSocialEnterprises?.title,
    },
  })
      ...
      <section className="container">
        {isLoadingCounty ? (
          ...
          <Paper shadow="lg" p="md" radius="md" withBorder className="w-full">
            ...
            {!isEdit && countyData?.topicalBusinessIssues?.helpForSocialEnterprises ? (
              <ContentPreview content={countyData?.topicalBusinessIssues?.helpForSocialEnterprises} />
            ) : (
              <CountySectionForm
                register={register}
...
export default HelpForSocialEnterprisesSection
