          ...
          <section className="mx-4 space-y-4 py-4 text-justify text-sm font-thin md:container md:mx-auto md:max-w-screen-md md:py-8">
            ...
            <ul className="ml-4 list-disc space-y-2 text-justify">
              <li>
                ...
                phone numbers; email addresses; mailing addresses; job titles;
                postal or zip codes; contact preferences; data collected from
                surveys; usernames; passwords; contact or authentication data;
                information you provide when using our products (e.g., business
                name, business email, business address, business fax, company
                website, etc.); number of unique views and total number of
                visitors when you deploy your cookie banner using our consent
                management solution; information in blog comments; profile
                photo; and other similar information.
              </li>
              <li>
            ...
            <ul className="ml-4 list-disc space-y-2 text-justify">
              ...
              <li>
                ...
                us at support@termly.io and be sure to include your name,
                testimonial location, and contact information.
              </li>
              <li>
                <span className="font-semibold">To protect our Services.</span>{' '}
            ...
            <p>
              ...
              following categories of third parties. If we have processed your
              data based on your consent and you wish to revoke your consent,
            ...
            <p>
              ...
              your third-party social media account details (like your Linkedin
              or Facebook or Twitter logins). Where you choose to do this, we
            ...
            <p>
              We are an internationally based company with operations in the
              United States and United Kingdom. Our servers are located in the
              United States. In order to provide our Services to you, please be
            ...
            <p>
              ...
              your country. With that in mind, we use appropriate safeguards
              when we transfer your information outside the EEA or UK to ensure
              your personal information remains protected and to comply with
            ...
            <ul className="ml-4 list-disc space-y-2 text-justify">
              <li>
                ...
                adequacy decisions to transfer your information outside the EEA
                or UK. When the relevant EU or UK authority issues an adequacy
                decision, that means they found the third country to offer
                adequate protection for personal information.
              </li>
              <li>
                Derogations. We may transfer information based on a derogation
                listed in Article 49 of the GDPR. We will only do so if the
                transfer of information meets specific strict conditions.
              </li>
              <li>
                ...
                between us and our group companies and between us and our
                ...
                safeguards with our third-party service providers and further
                details can be provided upon request.
              </li>
              <li>
                Supplementary Measures. When necessary, in addition to the
                Standard Contractual Clauses, we may adopt technical,
                contractual, and organizational supplementary measures to better
                ensure that the level of protection guaranteed by the GDPR is
                not undermined by the transfer.
              </li>
            </ul>
            <h2 className="font-semibold">
            ...
            <p>
              ...
              may email us at{' '}
              <a
                href="mailto:support@steppingstonesapp.com"
                className="underline"
              >
                support@steppingstonesapp.com
              </a>
            ...
            <p>
              ...
              advertisers on our Website, click{' '}
              <a
            ...
            <p>
              ...
              personal information, please do so by contacting us using the
