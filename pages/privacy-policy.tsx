        ...
        <section className="md:container mx-4 md:mx-auto md:max-w-screen-md space-y-4 py-4 md:py-8 text-sm text-justify font-thin">
          ...
          <ul className="ml-4 list-disc space-y-2 text-justify">
            <li>
              ...
              number of unique views and total number of visitors when you
              deploy your cookie banner using our consent management solution;
          ...
          <p>
            ...
            information through cookies and similar technologies. You can find
            out more about this in our{' '}
            <Link href={'/cookie-policy'}>
              <a className="text-gray-900 underline">Cookie Notice</a>
            </Link>
            .
          </p>
          ...
          <p>
            ...
            promotion. If you interact with us on a social media platform using
            your social media account (e.g. Facebook or Twitter), we receive
            personal information about you such as your name, email address, and
          ...
          <ul className="ml-4 list-disc space-y-2 text-justify">
            ...
            <li>
              ...
              at support@termly.io and be sure to include your name, testimonial
              location, and contact information.
            </li>
            <li>
              <span className="font-semibold">To protect our Services.</span> We
              may use your information as part of our efforts to keep our
          ...
          <p>
            ...
            please contact us using the contact details provided in the section
            below titled “
          ...
          <p>
            ...
            your country. With that in mind, we use appropriate safeguards when
            we transfer your information outside the EEA or UK to ensure your
          ...
          <ul className="ml-4 list-disc space-y-2 text-justify">
            ...
            <li>
              ...
              us and our group companies and between us and our third-party
              ...
              regulations. Our Standard Contractual Clauses can be provided upon
              request. We have implemented similar appropriate safeguards with
              our third-party service providers and further details can be
              provided upon request.
            </li>
            <li>
              Supplementary Measures. When necessary, in addition to the
              Standard Contractual Clauses, we may adopt technical, contractual,
              and organizational supplementary measures to better ensure that
          ...
          <p>
            ...
            so we cannot promise or guarantee that hackers, cyber criminals, or
          ...
          <p>
            ...
            age 18, please contact us at support@steppingstonesapp.com.
          </p>
          ...
          <p>
            ...
            please do so by contacting us using the information listed above.
          </p>
        </section>
      </section>
    </MainLayout>
