      ...
      <section className="relative bg-slate-50">
        <section className="container mx-auto max-w-screen-md space-y-2 py-8 text-justify font-normal">
          ...
          <p>
            ...
            and other related web properties are for informational purposes
            only.
          </p>
          <p>
          ...
          <p>
            ...
            are not under the control of SteppingStonesApp.com. We have no
            control over the nature, content and availability of those websites.
          ...
          <p>
            Our Website is provided by More Media Tech International for
            Stepping Stones on an "AS IS" basis.
          </p>
          <p>
          ...
          <p>
            Stepping Stones will not be liable for any damages of any kind
