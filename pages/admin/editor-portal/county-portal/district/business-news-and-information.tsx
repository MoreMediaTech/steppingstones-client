...
const BusinessNewsAndInformation = ({ district }: {district: string}) => {
console.log("🚀 ~ file: business-news-and-information.tsx ~ line 12 ~ BusinessNewsAndInformation ~ district", district)
...
export default BusinessNewsAndInformation
