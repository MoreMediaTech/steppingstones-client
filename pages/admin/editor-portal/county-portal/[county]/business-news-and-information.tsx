...
import { BusinessNewsAndInformationSection } from '@components/CountyDistrictSections'

const BusinessNewsAndInformation = ({
  county,
  countyId,
}: {
  county: string
       ...
       >
         <section className="h-screen overflow-auto bg-stone-100">
           ...
           <section className="container mx-auto">
             <BusinessNewsAndInformationSection id={countyId} />
           </section>
         </section>
       </ComponentShield>
     </AdminLayout>
