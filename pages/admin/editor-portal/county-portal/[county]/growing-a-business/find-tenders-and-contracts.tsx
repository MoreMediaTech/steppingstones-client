...
import { FindStartupFundingSection, FindTendersAndContractsSection } from '@components/CountyDistrictSections'
import Button from '@components/Button'

const FindTendersAndContracts = ({
  county,
  countyId,
}: {
  county: string
      ...
      >
        <section className="h-screen overflow-auto bg-stone-50">
          ...
          <section className="container mx-auto">
            <FindTendersAndContractsSection id={countyId} />
          </section>
        </section>
      </ComponentShield>
    </AdminLayout>
...
export default FindTendersAndContracts
