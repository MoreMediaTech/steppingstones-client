...
import { TradingOverseasSection } from '@components/CountyDistrictSections'

const TradingOverseas = ({
  county,
  countyId,
}: {
  county: string
     ...
     >
       <section className="h-screen overflow-auto bg-stone-100">
         ...
         <section className="container mx-auto">
          <TradingOverseasSection id={countyId} />
         </section>
       </section>
     </ComponentShield>
   </AdminLayout>
...
export default TradingOverseas
