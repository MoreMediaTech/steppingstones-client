...
import { FindNewMarketsSections } from '@components/CountyDistrictSections'
import Button from '@components/Button'

const FindNewMarkets = ({
  county,
  countyId,
}: {
  county: string
      ...
      >
        <section className="h-screen overflow-auto bg-stone-50">
          ...
          <section className="container mx-auto">
            <FindNewMarketsSections id={countyId} />
          </section>
        </section>
      </ComponentShield>
    </AdminLayout>
