...
import { HelpForMentalHealthAndWellBeingSection } from '@components/CountyDistrictSections'

const HelpForMentalHealthAndWellbeing = ({
  county,
  countyId,
}: {
  county: string
        ...
        >
          <section className="h-screen overflow-auto bg-stone-100">
            ...
            <section className="container mx-auto">
              <HelpForMentalHealthAndWellBeingSection id={countyId} />
            </section>
          </section>
        </ComponentShield>
      </AdminLayout>
...
export default HelpForMentalHealthAndWellbeing
