...
import { LGBTQandDisabilitiesSection } from '@components/CountyDistrictSections'
import Button from '@components/Button'

const LGBTQAndDisabilities = ({
  county,
  countyId,
}: {
  county: string
        ...
        <section className="h-screen overflow-auto bg-stone-50">
          <section className="sticky w-full bg-white shadow-lg">
            ...
            <section className="container mx-auto">
              <LGBTQandDisabilitiesSection id={countyId} />
            </section>
        </section>
      </ComponentShield>
    </AdminLayout>
...
export default LGBTQAndDisabilities
