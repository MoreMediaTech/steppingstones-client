    ...
    <MainLayout>
      <section className="relative mt-24 bg-slate-50">
        <section className="container mx-auto max-w-screen-md space-y-4 py-8 text-justify font-normal">
          ...
          <p>
            This Cookie Policy explains how Stepping Stones, a product of More
            Media International Ltd UK ("Company", "we", "us", and "our") uses
          ...
          <p>
            Cookies set by the website owner (in this case, More Media
            International Ltd UK) are called "first party cookies". Cookies set
