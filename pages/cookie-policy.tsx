        ...
        <section className="relative mt-24 bg-slate-50 py-8">
          <section className="mx-4 space-y-4 py-4 text-justify text-sm font-thin md:container md:mx-auto md:max-w-screen-md md:py-8">
            ...
            <p>
              ...
              Equilibrium Startup Lab LLC ("Company", "we", "us", and "our")
            ...
            <p>
              Cookies set by the website owner (in this case, Equilibrium
              Startup Lab LLC) are called "first party cookies". Cookies set by
